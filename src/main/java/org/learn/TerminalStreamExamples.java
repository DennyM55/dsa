 ...
 * Learn: collect(), reduce(), forEach(), count(), min(), max(), anyMatch(), allMatch()
 */
public class TerminalStreamExamples {

    public static void main(String[] args) {
        System.out.println("=== TERMINAL STREAM OPERATIONS ===\n");
        ...
        boolean anyGreaterThan35 = numbers.stream()
                .anyMatch(n -> n > 35);
