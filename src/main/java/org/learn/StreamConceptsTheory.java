...
/**
 * Stream API Concepts and Theory
 * Covers: What is Stream API, Why was it introduced, and core concepts
 */
public class StreamConceptsTheory {

    public static void main(String[] args) {
        System.out.println("=== STREAM API CONCEPTS AND THEORY ===\n");
        ...
        System.out.println("   map(identity): " + 
        ...
        System.out.println("   Example (without collect - no execution):");
        numbers.stream()
                .filter(n -> {
        ...
        System.out.println("   (Nothing printed - operations not executed)\n");
        
        System.out.println("   Example (with collect - operations are executed):");
        numbers.stream()
                .filter(n -> {
                    System.out.println("   filter called for: " + n);
                    return n > 5;
        ...
        System.out.println("   Benefits: Can use lambda expressions instead of anonymous classes\n");
        ...
        System.out.println("   Benefits: Cleaner code, functional programming, lazy evaluation\n");

        // Concept 10: Default Methods in Interfaces
        System.out.println("10. What are Default Methods in Interfaces?");
        System.out.println("    Methods with implementation in an interface (Java 8+)");
        System.out.println("    Declared with 'default' keyword");
        System.out.println("    Reason: Backward compatibility when adding new methods");
        System.out.println("    Allows interfaces to evolve without breaking existing code\n");

        // Concept 11: Optional
        System.out.println("11. What is Optional and why do we use it?");
        ...
        System.out.println("    Example: " + first.map(String::toUpperCase).orElse("EMPTY"));
        System.out.println("    WHY: Avoids NullPointerException, forces explicit null handling");
        System.out.println("         More readable and functional way to handle missing values\n");
    }
}
