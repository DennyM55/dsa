package org.learn.streams.basics;
...
/**
 * 02 - Basic Stream Examples
 * Learn: filter(), map(), collect()
 * 
 * Study this after: P01_StreamConceptsTheory
 */
public class P02_BasicStreamExamples {

    public static void main(String[] args) {
        System.out.println("=== 02 | BASIC STREAM EXAMPLES ===\n");
